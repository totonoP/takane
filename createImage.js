...
const takane = [{code:"cusual", img:"shihuku-nomal-nomal2", name:"基本"},
		...
		{code:"suit", img:"sutsu-nomal-henme", name:" 半目"},
...
function toDraw() {//文字を画像に描画
	...
	ctx.font = "48px";
	ctx.style.fontFamily = "'Helvetica Neue', 'Helvetica', 'Hiragino Sans', 'Hiragino Kaku Gothic ProN', 'Arial', 'Yu Gothic', 'Meiryo', 'sans-serif'";
